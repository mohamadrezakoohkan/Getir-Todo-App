...
public struct SwipeMenuViewOptions {
    ...
    public struct TabView {
        ...
        /// Newly configuration for offset, usage -> search bar
        public var topOffset: CGFloat = 60
...
open class SwipeMenuView: UIView {
    ...
    private func layout(contentScrollView: ContentScrollView) {
        ...
        NSLayoutConstraint.activate([
            contentScrollView.topAnchor.constraint(equalTo: self.topAnchor, constant: options.tabView.height + options.tabView.topOffset),
